$(document).ready(function () {
  ...
  $('.selected__link').click(function () {
    ...
    if ($(this).text() === 'Thông Tin Sản Phẩm') {
      $('.content').append(
            `<p>Tên sản phẩm: Đồ chơi sưu tập trứng kỳ lân kem ngọt ngào Zuru Rainbocorns Sweet Shake S2</p>
            <p>Thương hiệu: Rainbocorns</p>
            <p>Bảo hành: Không</p>
            <p>Kích thước: 24 x 22.7 x 35 cm</p>
            <p>Trọng lượng: kg</p>
            <p>Cảnh báo sử dụng: Không dùng cho trẻ dưới 3 tuổi. Có chi tiết nhỏ</p>
            <p>Chất liệu: Polyester, nhựa PP, ABS, PVC, kim loại</p>
            <p>Xuất xứ: Trung Quốc</p>
            <p>Hướng dẫn sử dụng: Chơi và trưng bày</p>
            <p>Sử dụng pin: Có sử dụng pin</p>`
    ...
    if ($(this).text() === 'Bình Luận') {
      ...
      <div class='card'>
        <div class="card-footer py-3 border-0" style="background-color: #f8f9fa">
            <div class="d-flex flex-start w-100">
              <img class="rounded-circle shadow-1-strong me-3" src="../img/img-avatar-4.png" alt="avatar" width="40" height="40"/>
              <div class="form-outline w-100">
                <label class="form-label" for="textAreaExample">Bình luận</label>
                <textarea class="form-control" id="textAreaExample" rows="4" style="background: #fff" placeholder="Hãy để lại bình luận ở đây!"></textarea>
              </div>
            </div>
      ...
      comments.filter((item) => {
        ...
        <div class="card-body">
          <div class="d-flex flex-start align-items-center">
            <img class="rounded-circle shadow-1-strong me-3" src=${item.imgUrl} alt="avatar" width="60" height="60"/>
            <div>
      ...
      $('.post').click(function () {
        ...
        <div class="card-body">
          <div class="d-flex flex-start align-items-center">
            <img class="rounded-circle shadow-1-strong me-3" src='../img/img-avatar-4.png' alt="avatar" width="60" height="60"/>
            <div>
